    ...
    (let [chart (chart/statechart {}
                  (state {:id :start}
                    (on-entry {}
                      ...
                      (If {:cond (fn [_ data] (= (get data :x) 1))}
                        (assign {:location [:result] :expr :first})
                        (elseif {:cond (fn [_ data] (= (get data :x) 2))}
                          (assign {:location [:result] :expr :second}))
                        (elseif {:cond (fn [_ data] (= (get data :x) 3))}
    ...
    (let [chart (chart/statechart {}
                  (state {:id :start}
                    (on-entry {}
                      ...
                      (foreach {:array    (fn [_ data] (get data :items))
                                   :item  [:current]
                                   :index [:idx]}
                        (assign {:location [:sum]
                                 :expr     (fn [_ data]
    ...
    (let [chart (chart/statechart {}
                  (state {:id :start}
                    (on-entry {}
                      ...
                      (If {:cond (fn [_ data] (> (get data :x) 0))}
                        (If {:cond (fn [_ data] (> (get data :y) 5))}
                  ...
                  (state {:id :start}
                    (on-entry {}
                      ...
                      (foreach {:array   (fn [_ _] [1 2 3 4 5 6])
                                   :item [:n]}
                        (If {:cond (fn [_ data] (even? (get data :n)))}
