...
(defn resolve-aliases [{:keys [_sessionid _event fulcro/app fulcro/state-map] :as env-or-data}]
  (let [session-id (or _sessionid (:target _event) (senv/session-id env-or-data))
