...
There is a predefined `WorkingMemoryDataModel` that stores scoped data for states within the session working memory,
allowing the data, for example, to be persisted with the state of a running session when pausing it for later revival.
