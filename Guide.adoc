...
The internals allow you to return a collection of elements from a function, which will be "spliced" in place. This allows you to easily create macros and functions that can make your statecharts much easier to write. Some examples in the library source code are the
